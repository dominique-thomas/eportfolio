...
let data = [
    ...
    
    {
        ...
        reflection: "This project was interesting and more challenging than I anticipated. Finding appropriate videos to illustrate the concepts took longer than expected. Additionally, developing the site was time-consuming. Despite my previous experience with video and website development, I assumed this project would be straightforward. However, I encountered unforeseen challenges that extended the development time. This eye-opening experience taught me to avoid making such assumptions in the future and to better anticipate/mitigate potential obstacles in future projects.<br><br>Ultimately, this project allowed me to further practice and refine my skill sets.",
