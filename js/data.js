...
let data = [
    ...
    
    {
        ...
        year: "2024", 
        role: "For this project, I modified the website I originally built for the <a href='projects.html?id=IMP_BIAS' title='Implicit Biases'>Implicit Biases</a> project. I also produced videos with closed captions (CC) and designed the final assessment simulation.", 
    ...
    
    {
        ...
        keywords: ["Personal Project", "Instructional Design", "Web Design", "Video Editing", "Featured"],
        year: "2024", 
        role: "For this project, I designed and developed the website and videos. I also handled uploading and timing the closed captions (CC). I also set up and uploaded the training to SCORM Cloud, a Learning Management System (LMS).", 
        scope: "Given the limitations on showcasing live training from previous projects, I wanted to create a project that highlights my expertise in instructional design, multimedia design, and web design. This training is intended for a corporate training setting and can be conducted in a self-paced eLearning environment. The target audience for this project is individuals aged 18 and older.", 
        solution: "I created several videos to introduce students to the concept of implicit biases, a topic that appears in all aspects of life. These videos cover key topics such as the origins of biases, common types of implicit biases, and strategies for mitigating these biases.<br><br>I developed a webpage to host the video content. The site includes features commonly found in traditional eLearning courses, such as navigational controls and a slide indicator. The site also enhances learning retention with additional content like reflection questions, resources, quizzes, and a final assessment. The site tracks student progress and completion status. It also functions as both a stand-alone platform in a browser and within an LMS. I chose this dual functionality to provide flexibility, as many courses benefit from the option to operate both within and outside of an LMS.<br><br>While creating a site from scratch takes more time, it offers greater flexibility to add robust features not available in traditional authoring programs, such as interactive closed captioning, serious games, and high-end simulations. Additionally, building from scratch allows for reusability and expansion of the existing baseline as needed.", 
        reflection: "This project was interesting and more challenging than I anticipated. Finding appropriate videos to illustrate the concepts took longer than expected. Also, developing the site was time-consuming. Despite my previous experience with video and website development, I assumed this project would be straightforward. However, I encountered unforeseen challenges that extended the development time. This eye-opening experience taught me to avoid making such assumptions in the future and to better anticipate/mitigate potential obstacles in future projects. Ultimately, this project allowed me to further practice and refine my skill sets.",
...

    {
        ...
        solution: "I used the <i>Unity</i> game engine to design a simulation that centers around the experience of preparing for a dinner party. Students assume the role of a homeowner tasked with completing various party preparations, such as tidying up the living room and assembling a dining room table. The simulation offers high interactivity and exploration within the confines of the house, allowing students to click on labeled interactive areas to receive feedback. Some interactions require specific tools or materials to complete a task, adding depth to the experience.", 
        reflection: "I believe that simulations should strike a balance between realism and enjoyment. In this simulation, I opted for a relatable scenario to captivate a diverse audience. I embodied this philosophy by integrating elements such as a to-do list and an instruction manual, as well as enjoyable elements such as exploration. My aim was to create an experience that is both informative and engaging for the student.<br><br>During the development process, I encountered challenges that tested my problem-solving skills. Despite facing obstacles, I persevered by finding workarounds.<br><br>This project was a lot of fun and offered me a rare opportunity to delve into simulation development using a game engine. It serves as a constant motivation for me to continually hone and refine my skills in this field.",
